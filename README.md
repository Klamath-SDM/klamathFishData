...
- `predation_estimates_avian_pit_tag`, `predation_estimates_wild` and
  `predation_estimates_hatchery` - Predation Estimates on SARP, Chinook
  and wild Suckers, and Avian Predation PIT-tag Recoveries
